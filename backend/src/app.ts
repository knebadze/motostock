...
import { privacyPolicyRouter } from "./modules/privacy-policy/privacy-policy.routes.js";
import { emailTemplatesRouter } from "./modules/email-templates/email-templates.routes.js";
import { orderStatusesRouter } from "./modules/order-statuses/order-statuses.routes.js";
...
import { bulkDiscountsRouter } from "./modules/bulk-discounts/bulk-discounts.routes.js";
import { bulkDiscountEventsRouter } from "./modules/bulk-discount-events/bulk-discount-events.routes.js";
...
app.use("/api/bulk-discounts", bulkDiscountsRouter);
app.use("/api/bulk-discount-events", bulkDiscountEventsRouter);
