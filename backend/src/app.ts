...
import { homepageProductSlidersRouter } from "./modules/homepage-product-sliders/homepage-product-sliders.routes.js";
...
app.use("/api/homepage-product-sliders", homepageProductSlidersRouter);
