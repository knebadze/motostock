...
export default async function AccountDashboardPage() {
  ...
  return <AccountDashboardView name={user?.name ?? ""} />;
}

// No email-verification reminder here — account/layout.tsx's hard gate
// already guarantees an unverified account never reaches this page (see
// its redirect to /verify-required).
function AccountDashboardView({ name }: { name: string }) {
