        ...
        <div className="flex flex-col gap-3 rounded-xl border border-border p-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              ჩართული, ეს მხოლოდ აღნიშნავს, რომელი ბანკი მხარს დაუჭერს, როცა დაინერგება. ორივე
              შეირჩევა თავად ბანკის გვერდზე გადახდისას — ამ ბანკისთვის ჩართვამდე საჭირო იქნება
              მისი გადახდის API-ის კრედენშალების კონფიგურირება სერვერის მხარეს.
            </p>
          </div>
