  ...
  return (
    <div>
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        ...
        თითოეულის რაოდენობა ცალ-ცალკე რეგულირდება. „პოპულარული მომხმარებლის ტრანსპორტისთვის”,
        „რეკომენდებული” და „ბოლოს ნანახი” სექციები პერსონალიზებულია — თითოეულ ვიზიტორს განსხვავებული
        შედეგი უჩნდება (ან საერთოდ არაფერი, თუ ვიზიტორს ტრანსპორტი არჩეული არ აქვს, საკმარისი
        ისტორია არ არსებობს, ან ჯერ არაფერი უნახავს), ამიტომ ცარიელი გამოჩენა ამ სამი ტიპისთვის
        ხარვეზი არაა.
      </p>
