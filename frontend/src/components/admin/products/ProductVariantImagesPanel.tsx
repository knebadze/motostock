...
export function ProductVariantImagesPanel({
  ...
  // over the [] it mounted with. A ref write during render is disallowed by
  // this project's lint rules, hence the dedicated effect instead of just
  // assigning localImagesRef.current = localImages inline.
